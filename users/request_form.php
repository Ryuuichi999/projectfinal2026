                ...
                <div class="row mt-5">
                    <div class="col-12 text-center">
                        <div class="mt-4 mb-4 p-3 border rounded bg-light text-start">
                            <p class="mb-0" style="text-align: justify; text-indent: 40px; line-height: 1.8;">
                                ข้าพเจ้าได้ระบุสถานที่ที่จะติดตั้งป้าย ปิด ทิ้ง โปรย แผ่นประกาศใบปลิว สถานที่ใกล้เคียงพร้อมตัวอย่างของสื่อโฆษณามาด้วยแล้ว
                                และขอรับรองว่าเมื่อครบกำหนดเวลาในหนังสือขออนุญาตแล้วจะเก็บ ปลดถอน ขูด ลบ หรือล้าง ป้าย ปิดทิ้ง โปรย แผ่นประกาศใบปลิว
                                ออกจากบริเวณดังกล่าว ถ้าเกินกำหนดระยะเวลาแล้ว ข้าพเจ้าไม่ทำการรื้อถอน ทำให้เทศบาลต้องทำการรื้อถอนเอง
                                ...
                                ข้าพเจ้าจะเป็นผู้รับผิดชอบแต่เพียงผู้เดียว โดยข้าพเจ้าขอบันทึกข้อตกลงเพื่อยืนยันแนวทางปฏิบัติของข้าพเจ้า
                            </p>
                        </div>
