            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-8">
                    <div class="accordion" id="faqAccordion">
                        <?php
                        $faqs = [
                            ['ค่าธรรมเนียมคำนวณอย่างไร?', 'คิดตามจำนวนป้าย: <b>200 บาท</b>/ป้าย ทุกประเภท<br>ผู้ยื่นสามารถระบุระยะเวลาที่ต้องการติดตั้ง เจ้าหน้าที่จะพิจารณาอนุมัติตามความเหมาะสม<br><small class="text-muted">อ้างอิง: อัตราค่าธรรมเนียมตามระเบียบเทศบาลเมืองศิลา</small>'],
