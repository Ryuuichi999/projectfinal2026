                    ...
                    <div class="info-card">
                        ...
                        <div class="doc-grid">
                            ...
                            <div class="doc-item">
                                ...
                                <div class="doc-content">
                                    <h6>บทลงโทษ</h6>
                                    <p>ผู้ฝ่าฝืนมีความผิดตาม <b>พ.ร.บ.รักษาความสะอาดฯ พ.ศ. 2535</b> เจ้าหน้าที่มีอำนาจรื้อถอนและเรียกค่าใช้จ่ายคืน</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-8">
                    <div class="accordion" id="faqAccordion">
                        <?php
                        $faqs = [
                            ['ค่าธรรมเนียมคำนวณอย่างไร?', 'คิดตามจำนวนป้าย ไม่ขึ้นกับขนาด:<br>• ค่าธรรมเนียม <b>200 บาท</b> ต่อป้าย<br>เช่น 2 ป้าย = 400 บาท<br><small class="text-muted">อ้างอิง: อัตราค่าธรรมเนียมตามระเบียบเทศบาลเมืองศิลา</small>'],
                            ['ต้องยื่นล่วงหน้ากี่วัน?', 'ต้องยื่นคำขออนุญาต<b>ก่อนวันติดตั้งไม่น้อยกว่า 7 วัน</b> ตามข้อ 8.1 ของระเบียบ และเมื่อครบกำหนดต้องรื้อถอนภายใน 7 วัน'],
                            ['ใช้เวลากี่วันในการอนุมัติ?', 'เจ้าหน้าที่จะตรวจสอบและพิจารณาภายใน <b>7 วันทำการ</b> หลังจากยื่นคำร้องพร้อมเอกสารครบถ้วน'],
                            ['ชำระเงินอย่างไร?', 'เมื่อเจ้าหน้าที่อนุมัติแล้ว ระบบจะแจ้งให้ชำระเงิน:<br>1. สแกน QR Code PromptPay ในหน้าชำระเงิน<br>2. อัปโหลดสลิปการโอน<br>3. ระบบตรวจสอบสลิปอัตโนมัติ<br>4. รับใบเสร็จทันที'],
                            ['ป้ายขนาดเท่าไหร่ที่อนุญาต?', 'ป้ายชั่วคราว (ผ้า/กระดาษ/พลาสติก) ขนาดไม่เกิน <b>2.40 × 1.20 เมตร</b> สูงจากพื้นไม่น้อยกว่า 1 เมตร และสูงรวมไม่เกิน 3 เมตร ตามระเบียบข้อ 3.3'],
                            ...
                            ['ต่ออายุใบอนุญาตได้อย่างไร?', 'ต้องยื่นคำขออนุญาตใหม่ทุกครั้ง โดยกดปุ่ม <b>"ต่ออายุ"</b> ในหน้าสถานะคำขอ ระบบจะดึงข้อมูลเดิมมาให้อัตโนมัติ'],
                            ['QR Code บนหนังสืออนุญาตใช้ทำอะไร?', 'ใช้สำหรับ<b>ตรวจสอบความถูกต้อง</b>ของหนังสืออนุญาต เจ้าหน้าที่หรือประชาชนสแกนเพื่อยืนยันว่าใบอนุญาตยังไม่หมดอายุและเป็นของจริง'],
